...
lmoves_raichu = {'01': ['ThunderShock', 'Growl', 'Thunder Wave']}
tmoves_raichu = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Pay Day", "Submission", "Seismic Toss", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Reflect", "Bide", "Swift", "Skull Bash", "Rest", "Thunder Wave", "Substitute", "Agility", "Light Screen", "Quick Attack", "Slam", "Tail Whip"]
hmoves_raichu = ["Flash", "Fly", "Surf"]
lmoves_sandshrew = {'01': ['Scratch'], '10': ['Sand-Attack'], '17': ['Slash'], '24': ['Poison Sting'], '31': ['Swift'], '38': ['Fury Swipes']}
tmoves_sandshrew = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Submission", "Seismic Toss", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_sandshrew = ["Cut", "Strength"]
lmoves_sandslash = {'01': ['Scratch', 'Sand-Attack'], '10': ['Sand-Attack'], '17': ['Slash'], '27': ['Poison Sting'], '36': ['Swift'], '47': ['Fury Swipes']}
tmoves_sandslash = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Submission", "Seismic Toss", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_sandslash = ["Cut", "Strength"]
lmoves_nidoran_f = {}
tmoves_nidoran_f = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Blizzard", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_nidoran_f = []
lmoves_nidorina = {}
tmoves_nidorina = ["Toxic", "Horn Drill", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_nidorina = []
lmoves_nidoqueen = {}
tmoves_nidoqueen = ["Mega Punch", "Mega Kick", "Toxic", "Horn Drill", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Hyper Beam", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Thunderbolt", "Thunder", "Earthquake", "Fissure", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Skull Bash", "Rest", "Rock Slide", "Substitute", "Bite", "Double Kick", "Fury Swipes", "Growl", "Poison Sting"]
hmoves_nidoqueen = ["Surf", "Strength"]
lmoves_nidoran_m = {}
tmoves_nidoran_m = ["Toxic", "Horn Drill", "Body Slam", "Take Down", "Double-Edge", "Blizzard", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_nidoran_m = []
lmoves_nidorino = {}
tmoves_nidorino = ["Toxic", "Horn Drill", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_nidorino = []
lmoves_nidoking = {}
tmoves_nidoking = ["Mega Punch", "Mega Kick", "Toxic", "Horn Drill", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Hyper Beam", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Thunderbolt", "Thunder", "Earthquake", "Fissure", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Skull Bash", "Rest", "Rock Slide", "Substitute", "Double Kick", "Focus Energy", "Fury Attack", "Leer"]
hmoves_nidoking = ["Surf", "Strength"]



lmoves_vulpix = {'01': ['Ember', 'Tail Whip'], '16': ['Quick Attack'], '21': ['Roar'], '28': ['Confuse Ray'], '35': ['Flamethrower'], '42': ['Fire Spin']}
tmoves_vulpix = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Rage", "Dig", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Swift", "Skull Bash", "Rest", "Substitute"]
hmoves_vulpix = []
lmoves_ninetales = {'01': ['Ember', 'Tail Whip', 'Quick Attack', 'Roar']}
tmoves_ninetales = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Dig", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Swift", "Skull Bash", "Rest", "Substitute", "Confuse Ray", "Fire Spin", "Flamethrower"]
hmoves_ninetales = []



lmoves_zubat = {'01': ['Leech Life'], '10': ['Supersonic'], '15': ['Bite'], '21': ['Confuse Ray'], '28': ['Wing Attack'], '36': ['Haze']}
tmoves_zubat = ["Razor Wind", "Whirlwind", "Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "Mimic", "Double Team", "Bide", "Swift", "Rest", "Substitute"]
hmoves_zubat = []
lmoves_golbat = {'01': ['Leech Life', 'Screech', 'Bite'], '10': ['Supersonic'], '15': ['Bite'], '21': ['Confuse Ray'], '32': ['Wing Attack'], '43': ['Haze']}
tmoves_golbat = ["Razor Wind", "Whirlwind", "Toxic", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Mega Drain", "Mimic", "Double Team", "Bide", "Swift", "Rest", "Substitute"]
hmoves_golbat = []
lmoves_oddish = {'01': ['Absorb'], '15': ['PoisonPowder'], '17': ['Stun Spore'], '19': ['Sleep Powder'], '24': ['Acid'], '33': ['Petal Dance'], '46': ['SolarBeam']}
tmoves_oddish = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute"]
hmoves_oddish = ["Cut"]
lmoves_gloom = {'01': ['Absorb', 'PoisonPowder', 'Stun Spore'], '15': ['PoisonPowder'], '17': ['Stun Spore'], '19': ['Sleep Powder'], '28': ['Acid'], '38': ['Petal Dance'], '52': ['SolarBeam']}
tmoves_gloom = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute"]
hmoves_gloom = ["Cut"]
lmoves_vileplume = {'01': ['Stun Spore', 'Sleep Powder', 'Acid', 'Petal Dance'], '15': ['PoisonPowder'], '17': ['Stun Spore'], '19': ['Sleep Powder']}
tmoves_vileplume = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute", "Absorb"]
hmoves_vileplume = ["Cut"]
lmoves_paras = {'01': ['Scratch'], '13': ['Stun Spore'], '20': ['Leech Life'], '27': ['Spore'], '34': ['Slash'], '41': ['Growth']}
tmoves_paras = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Dig", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_paras = ["Cut"]
lmoves_parasect = {'01': ['Scratch', 'Stun Spore', 'Leech Life'], '13': ['Stun Spore'], '20': ['Leech Life'], '30': ['Spore'], '39': ['Slash'], '48': ['Growth']}
tmoves_parasect = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Mega Drain", "SolarBeam", "Dig", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_parasect = ["Cut"]
lmoves_venonat = {}
tmoves_venonat = ["Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Psywave", "Substitute"]
hmoves_venonat = ["Flash"]
lmoves_venomoth = {}
tmoves_venomoth = ["Razor Wind", "Whirlwind", "Toxic", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Mega Drain", "SolarBeam", "Teleport", "Mimic", "Double Team", "Reflect", "Bide", "Swift", "Rest", "Psywave", "Substitute"]
hmoves_venomoth = ["Flash"]
lmoves_diglett = {'01': ['Scratch'], '15': ['Growl'], '19': ['Dig'], '24': ['Sand-Attack'], '31': ['Slash'], '40': ['Earthquake']}
tmoves_diglett = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Rest", "Rock Slide", "Substitute"]
hmoves_diglett = ["Cut"]
lmoves_dugtrio = {'01': ['Scratch', 'Growl', 'Dig'], '15': ['Growl'], '19': ['Dig'], '24': ['Sand-Attack'], '35': ['Slash'], '47': ['Earthquake']}
tmoves_dugtrio = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Rest", "Rock Slide", "Substitute"]
hmoves_dugtrio = ["Cut"]
lmoves_meowth = {'01': ['Scratch', 'Growl'], '12': ['Bite'], '17': ['Pay Day'], '24': ['Screech'], '33': ['Fury Swipes'], '44': ['Slash']}
tmoves_meowth = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Pay Day", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Substitute"]
hmoves_meowth = []
lmoves_persian = {'01': ['Scratch', 'Growl', 'Bite', 'Screech'], '12': ['Bite'], '17': ['Pay Day'], '24': ['Screech'], '37': ['Fury Swipes'], '51': ['Slash']}
tmoves_persian = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Hyper Beam", "Pay Day", "Rage", "Thunderbolt", "Thunder", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Substitute"]
hmoves_persian = []
lmoves_psyduck = {'01': ['Scratch'], '28': ['Tail Whip'], '31': ['Disable'], '36': ['Confusion'], '43': ['Fury Swipes'], '52': ['Hydro Pump']}
tmoves_psyduck = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Dig", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Substitute"]
hmoves_psyduck = ["Surf", "Strength"]
lmoves_golduck = {'01': ['Scratch', 'Tail Whip', 'Disable'], '28': ['Tail Whip'], '31': ['Disable'], '39': ['Confusion'], '48': ['Fury Swipes'], '59': ['Hydro Pump']}
tmoves_golduck = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Hyper Beam", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Dig", "Mimic", "Double Team", "Bide", "Swift", "Skull Bash", "Rest", "Substitute", "Amnesia"]
hmoves_golduck = ["Surf", "Strength"]
lmoves_mankey = {}
tmoves_mankey = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Thunderbolt", "Thunder", "Dig", "Mimic", "Double Team", "Bide", "Metronome", "Swift", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_mankey = ["Strength"]
lmoves_primeape = {}
tmoves_primeape = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Pay Day", "Submission", "Counter", "Seismic Toss", "Rage", "Thunderbolt", "Thunder", "Dig", "Mimic", "Double Team", "Bide", "Metronome", "Swift", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_primeape = ["Strength"]
lmoves_growlithe = {'01': ['Bite', 'Roar'], '18': ['Ember'], '23': ['Leer'], '30': ['Take Down'], '39': ['Agility'], '50': ['Flamethrower']}
tmoves_growlithe = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Rage", "Dragon Rage", "Dig", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Swift", "Skull Bash", "Rest", "Substitute"]
hmoves_growlithe = []
lmoves_arcanine = {'01': ['Roar', 'Ember', 'Leer', 'Take Down']}
tmoves_arcanine = ["Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Dragon Rage", "Dig", "Teleport", "Mimic", "Double Team", "Reflect", "Bide", "Fire Blast", "Swift", "Skull Bash", "Rest", "Substitute", "Agility", "Bite", "Flamethrower"]
hmoves_arcanine = []



lmoves_abra = {'01': ['Teleport']}
tmoves_abra = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Submission", "Counter", "Seismic Toss", "Rage", "Teleport", "Mimic", "Double Team", "Reflect", "Bide", "Metronome", "Skull Bash", "Rest", "Thunder Wave", "Psywave", "Tri Attack", "Substitute"]
hmoves_abra = ["Flash"]
lmoves_kadabra = {}
tmoves_kadabra = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Submission", "Counter", "Seismic Toss", "Rage", "Dig", "Teleport", "Mimic", "Double Team", "Reflect", "Bide", "Metronome", "Skull Bash", "Rest", "Thunder Wave", "Psywave", "Tri Attack", "Substitute"]
hmoves_kadabra = ["Flash"]
lmoves_alakazam = {}
tmoves_alakazam = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Submission", "Counter", "Seismic Toss", "Rage", "Dig", "Teleport", "Mimic", "Double Team", "Reflect", "Bide", "Metronome", "Skull Bash", "Rest", "Thunder Wave", "Psywave", "Tri Attack", "Substitute"]
hmoves_alakazam = ["Flash"]
lmoves_machop = {'01': ['Karate Chop'], '20': ['Low Kick'], '25': ['Leer'], '32': ['Focus Energy'], '39': ['Seismic Toss'], '46': ['Submission']}
tmoves_machop = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Submission", "Counter", "Seismic Toss", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Metronome", "Fire Blast", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_machop = ["Strength"]
lmoves_machoke = {'01': ['Karate Chop', 'Low Kick', 'Leer'], '20': ['Low Kick'], '25': ['Leer'], '36': ['Focus Energy'], '44': ['Seismic Toss'], '52': ['Submission']}
tmoves_machoke = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Submission", "Counter", "Seismic Toss", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Metronome", "Fire Blast", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_machoke = ["Strength"]
lmoves_machamp = {'01': ['Karate Chop', 'Low Kick', 'Leer'], '20': ['Low Kick'], '25': ['Leer'], '36': ['Focus Energy'], '44': ['Seismic Toss'], '52': ['Submission']}
tmoves_machamp = ["Mega Punch", "Mega Kick", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Submission", "Counter", "Seismic Toss", "Rage", "Earthquake", "Fissure", "Dig", "Mimic", "Double Team", "Bide", "Metronome", "Fire Blast", "Skull Bash", "Rest", "Rock Slide", "Substitute"]
hmoves_machamp = ["Strength"]
lmoves_bellsprout = {'01': ['Vine Whip', 'Growth'], '13': ['Wrap'], '15': ['PoisonPowder'], '18': ['Sleep Powder'], '21': ['Stun Spore'], '26': ['Acid'], '33': ['Razor Leaf'], '42': ['Slam']}
tmoves_bellsprout = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute"]
hmoves_bellsprout = ["Cut"]
lmoves_weepinbell = {'01': ['Vine Whip', 'Growth', 'Wrap'], '13': ['Wrap'], '15': ['PoisonPowder'], '18': ['Sleep Powder'], '23': ['Stun Spore'], '29': ['Acid'], '38': ['Razor Leaf'], '49': ['Slam']}
tmoves_weepinbell = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute"]
hmoves_weepinbell = ["Cut"]
lmoves_victreebel = {'01': ['Sleep Powder', 'Stun Spore', 'Acid', 'Razor Leaf'], '13': ['Wrap'], '15': ['PoisonPowder'], '18': ['Sleep Powder']}
tmoves_victreebel = ["Swords Dance", "Toxic", "Body Slam", "Take Down", "Double-Edge", "Hyper Beam", "Rage", "Mega Drain", "SolarBeam", "Mimic", "Double Team", "Reflect", "Bide", "Rest", "Substitute", "Growth", "Slam", "Vine Whip"]
hmoves_victreebel = ["Cut"]
lmoves_tentacool = {'01': ['Acid'], '07': ['Supersonic'], '13': ['Wrap'], '18': ['Poison Sting'], '22': ['Water Gun'], '27': ['Constrict'], '33': ['Barrier'], '40': ['Screech'], '48': ['Hydro Pump']}
tmoves_tentacool = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Rage", "Mega Drain", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_tentacool = ["Cut", "Surf"]
lmoves_tentacruel = {'01': ['Acid', 'Supersonic', 'Wrap'], '07': ['Supersonic'], '13': ['Wrap'], '18': ['Poison Sting'], '22': ['Water Gun'], '27': ['Constrict'], '35': ['Barrier'], '43': ['Screech'], '50': ['Hydro Pump']}
tmoves_tentacruel = ["Swords Dance", "Toxic", "Take Down", "Double-Edge", "BubbleBeam", "Water Gun", "Ice Beam", "Blizzard", "Hyper Beam", "Rage", "Mega Drain", "Mimic", "Double Team", "Reflect", "Bide", "Skull Bash", "Rest", "Substitute"]
hmoves_tentacruel = ["Cut", "Surf"]
